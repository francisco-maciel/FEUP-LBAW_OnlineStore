    ...
    <div class="row">
        ...
        <div class="stepwizard">
            <div class="stepwizard-row">
                ...
                <div class="stepwizard-step">
                    <a href="{$BASE_URL}pages/products/payment.php" type="button"
...
<div class="row">
    <div id="confirmation">
        <button id="confirm_button_button" onClick="confirmPurchase()" class="col-lg-12 btn btn-block btn-success"><h3>
                Confirm purchase</h3></button>
    </div>

{foreach $products as $prod}
    <div class="col-sm-4 col-lg-4 col-md-4">
        <div class="thumbnail" id="{$prod.idproduct}">
            ...
            {if $prod.img }
                <a href="{$BASE_URL}pages/products/product.php?id={$prod.idproduct}"> <img
                            style="min-height:200px; max-height:200px; width:auto;" class="img-responsive"
                            src="{$BASE_URL}images/products/{$prod.img}" alt=""> </a>
            {else}
                <a href="{$BASE_URL}pages/products/product.php?id={$prod.idproduct}"> <img class="img-responsive"
                                                                                           src="{$BASE_URL}images/products/default.png"
                                                                                           alt=""> </a>
            {/if}
            ...
            <div class="caption">
                ...
                {if (strlen($prod.title)>28)}
                    <h4>
                        <a href="{$BASE_URL}pages/products/product.php?id={$prod.idproduct}">{substr($prod.title,0,28)}</a>
                    </h4>
                {else}

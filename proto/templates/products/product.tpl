            ...
            <div class="thumbnail">
                ...
                <div class="caption-full">
                    ...
                    <div class="text-left">
                        ...
                        <div class="controls">
                            {if $PERMISSION != 0}
                                <button onclick="editProduct()" id="" name="" class="btn btn-warning">Edit details <span
                                            class="glyphicon glyphicon-edit"></span></button>
                            {else}
                                <button id="" name="" class="btn btn-success">Add to Cart <span
                                            class="glyphicon glyphicon-shopping-cart"></span></button>
                                <button id="" name="" class="btn btn-labeled btn-warning">Add to wish-list <span
                                            class="glyphicon glyphicon glyphicon-star"></span></button>
                            {/if}

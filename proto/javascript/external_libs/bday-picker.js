  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year form-control input-md ' name='day'></select>"),
          $month = $("<select class='birth-month form-control input-md' name='month'></select>"),
          $day = $("<select class='birth-day form-control input-md' name='year'></select>"),
      ...
      if (settings["dateFormat"] == "bigEndian") {
        ...
        if (tabindex != null) {
          ...
          $fieldset.append( $div.clone().append($day));
          $fieldset.append( $div.clone().append($month));
          $fieldset.append( $div.clone().append($year));
      ...
      if (settings["defaultDate"]) {
        ...
        if (typeof settings["defaultDate"] == "boolean") {
      ...
      if (settings["defaultDate"]) {
         if (typeof settings["defaultDate"] == "boolean") var date = new Date();
         else var date = new Date(settings["defaultDate"] + "T00:00:00");
